...
**基础 URL：**
```
https://hihis.smukqyy.cn/webroot/decision/view/report?viewlet=hi%252Fhis%252FhiOpDoc%252Fguidance%252FMedpers_mzys.cpt&ref_t=design&ref_c=baa2e03a-c410-46b9-b92a-b2b25ff2
```
...
- [ ] 验证 Wails 安装：`wails version`  （v2.11.0）
- [ ] （Windows）确保系统已安装 WebView2 Runtime （windows 10需要手工安装）
